...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到空间站,Welcome to 🛰',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'web_site', // 网站地址
  ...
  WIDGET_PET_LINK:
      ...
      'https://raw.githubusercontent.com/imuncle/live2d/master/model/platelet-2/model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
