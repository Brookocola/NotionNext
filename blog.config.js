...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到空间站,Welcome to X-station🛰',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。


  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'mini4ter', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'whu.rs', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.mini4ter.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '空间站', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'shiyun.xn@whu.edu.cn', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Brookocola', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/164761025?spm_id_from=333.1007.0.0', // B站主页
...
<<<<<<< HEAD
      ...
      'https://raw.githubusercontent.com/imuncle/live2d/master/model/platelet/model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
...
>>>>>>> e1976aaf3e92cb68a2598563b00191b95a6532c9
...
<<<<<<< HEAD
      process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'Brookocola/xlog-comment', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
=======
