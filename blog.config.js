...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '欢迎来到空间站,Welcome to X-station🛰,瓦特反应慢,但不影响它活在当下',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'whu.rser', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.mini4ter.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'shiyun@whu.edu.cn', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/u/6009561671?lpage=profileRecom', // 你的微博个人主页
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/164761025', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || '', // Youtube主页
  CONTACT_XIAOHONGSHU: process.env.NEXT_PUBLIC_CONTACT_XIAOHONGSHU || 'https://www.xiaohongshu.com/user/profile/5fefe28f000000000100b04b', // 小红书主页
